...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { duration: @coupon.duration, name: @coupon.name, percent_off: @coupon.percent_off } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { duration: @coupon.duration, name: @coupon.name, percent_off: @coupon.percent_off } }
